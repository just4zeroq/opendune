...
class BitgetCollector:
    ...
    def __init__(
        ...
        self.secret = secret or settings.bitget_secret_key
        self.passphrase = passphrase or settings.bitget_passphrase
        ...
        logger.info("bitget_collector_initialized")

    async def start(self):
        """启动采集器"""
        self.running = True
        logger.info("bitget_collector_started")
    ...
    async def stop(self):
        ...
        logger.info("bitget_collector_stopped")
    ...
    async def _ticker_loop(self, symbol: str):
        ...
        while self.running:
            try:
                ...
                logger.error("bitget_ticker_error", symbol=symbol, error=str(e))
    ...
    async def _trades_loop(self, symbol: str):
        ...
        while self.running:
            try:
                ...
                logger.error("bitget_trades_error", symbol=symbol, error=str(e))
                await asyncio.sleep(5)
    ...
    async def _klines_loop(self, symbol: str, interval: str = "1m"):
        ...
        while self.running:
            try:
                ...
                logger.error("bitget_klines_error", symbol=symbol, error=str(e))
                await asyncio.sleep(5)
